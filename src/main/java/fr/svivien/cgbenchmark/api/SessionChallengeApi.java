...
public interface SessionChallengeApi {
    @POST("/services/ChallengeCandidateRemoteService/findChallengerByChallenge")
    @Headers({
    ...
    Call<SessionResponse> getSessionHandle(@Body SessionChallengeRequest body, @Header("Referer") String referer, @Header("Cookie") String userCookie);
}
